...
# v0.1
Minimal Tico Setup with boxarts, cores, roms. NO disc based systems, currently no boxart for FBNeo.
...
* ROMs
  * Based on 1G1R sets where available
  * FBNeo is using Cylum's set, based on 1.0.0.3, as obtained from the Internet Archive.
  * Disc based systems were skipped due to size: (almost 4tb for all systems supported and 2.8TB is mostly untested)
    * Nintendo Gamecube: 504GB
    * Nintendo Wii: 2.3TB
 ...
 tico_complete is an independent project not affiliated at all, with any person or entity, in perpetuity. It is not intended to replace tico, and will often lag behind tico in versioning. I do not own, license or own the rights to any material hosted here; it will be removed if the rightful owners file a complaint. No donations are expected or accepted. This is strictly a passion project and no financial incentive is to EVER be associated.
 
 No license is intended, implied or explicitly stated. Use and redistribute at will. If you charge for this, Akira Toriyama will haunt your dreams. He's not affiliated, I'm just a fan and calling in my special favor from the big dog upstairs.
